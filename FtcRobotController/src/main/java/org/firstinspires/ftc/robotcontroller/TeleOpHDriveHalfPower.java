...
@Disabled
public class TeleOpHDriveHalfPower extends LinearOpMode {
...
//Strafing motors move together to make the robot go left/right without turning
        ...
        rightSampleArm = hardwareMap.servo.get("rightSampleArm");
...
//Wait for the game to start
        ...
        while (opModeIsActive()) {
            ...
            rightSampleArm.setPosition(1.0);
            if (gamepad2.a) {
            ...
            if (gamepad2.y) {
                ...
                rightIntakeFlipper.setPosition(0.3);
            }
            if (gamepad2.b) {
            ...
            if (gamepad1.right_bumper) {
                landerFlipper.setPosition(0.4);

            }
            if (gamepad1.left_bumper) {
                landerFlipper.setPosition(0.0);
            }
            if (gamepad1.a) {
                //in
                intakeCR.setPower(1);
            ...
            if (gamepad2.dpad_down) {
                intakeWheels.setPosition(0.68);
            }
            if (gamepad2.dpad_up) {
                intakeWheels.setPosition(0.25);
            }
